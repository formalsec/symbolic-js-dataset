...
var selector = { view: esl_symbolic.any("view") };
var ret_new_module_exports = new module.exports(selector);
var string =
  [ esl_symbolic.string("string0"), esl_symbolic.string("string1") ];
ret_new_module_exports.parseQueryString(string);
