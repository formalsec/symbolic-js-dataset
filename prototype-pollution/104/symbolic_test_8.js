...
var host = {  };
var ret_new_module_exports_recursive = new module.exports.recursive(host);
var keys = [ esl_symbolic.string("keys0"), esl_symbolic.string("keys1") ];
var host = {  };
var ret_ret_new_module_exports_recursive_recursive = ret_new_module_exports_recursive.recursive(keys, host);
var key = esl_symbolic.string("key");
ret_ret_new_module_exports_recursive_recursive(key);
