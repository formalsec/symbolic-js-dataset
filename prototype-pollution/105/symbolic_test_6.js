...
var host = {  };
var ret_new_module_exports = new module.exports(host);
var host = {  };
var ret_ret_new_module_exports_recursive = ret_new_module_exports.recursive(host);
var key = esl_symbolic.string("key");
ret_ret_new_module_exports_recursive(key);
