...
// Vuln: path-traversal
var sourceFile = esl_symbolic.string("sourceFile");
var encoding = esl_symbolic.string("encoding");
var propertiesAppender = esl_symbolic.any("propertiesAppender");
var ret_new_module_exports = new module.exports(sourceFile, encoding, propertiesAppender);
var destFile = esl_symbolic.string("destFile");
var onComplete =
  [ esl_symbolic.string("onComplete0"), esl_symbolic.string("onComplete1") ];
ret_new_module_exports.save(destFile, onComplete);
