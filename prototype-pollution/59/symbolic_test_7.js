...
function realpathSync() {
    var args = _argsArray(arguments);
    return safeCall(function () { return fs.realpathSync.apply(fs, args); }, null);
}
...
var optionalThis = esl_symbolic.function("optionalThis");
var func = esl_symbolic.any("func");
var errorReturnValue = esl_symbolic.any("errorReturnValue");
var ret_new_module_exports = new module.exports(optionalThis, func, errorReturnValue);
var o = [ esl_symbolic.string("o0") ];
var s = [ esl_symbolic.string("s0"), esl_symbolic.string("s1") ];
var value = esl_symbolic.any("value");
ret_new_module_exports.set(o, s, value);
