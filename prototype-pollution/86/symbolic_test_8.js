...
var result =
  [ esl_symbolic.string("result0"), esl_symbolic.string("result1") ];
var initial = esl_symbolic.any("initial");
var options =
  { depth: esl_symbolic.number("depth")
  , deep: esl_symbolic.any("deep") };
module.exports(result, initial, options);
