...
var args = [ esl_symbolic.string("args0"), esl_symbolic.string("args1") ];
var opts = {  };
var ret_new_module_exports = new module.exports(args, opts);
var args = [ esl_symbolic.string("args0") ];
var opts = {  };
ret_new_module_exports.detailed(args, opts);
