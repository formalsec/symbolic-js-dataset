...
var config =
  { userId: esl_symbolic.any("userId")
  , password: esl_symbolic.any("password")
  , signature: esl_symbolic.any("signature")
  , appId: esl_symbolic.any("appId")
  , sandbox: esl_symbolic.any("sandbox") };
var ret_new_module_exports = new module.exports(config);
var params =
  { payKey: esl_symbolic.any("payKey")
  , transactionId: esl_symbolic.any("transactionId")
  , trackingId: esl_symbolic.any("trackingId") };
var callback = esl_symbolic.function("callback");
ret_new_module_exports.paymentDetails(params, callback);
