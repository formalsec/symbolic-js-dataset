...
var parent =
  [ esl_symbolic.string("parent0"), esl_symbolic.string("parent1") ];
var namespace = esl_symbolic.string("namespace");
var value = [ esl_symbolic.string("value0"), esl_symbolic.string("value1") ];
var mode = esl_symbolic.any("mode");
