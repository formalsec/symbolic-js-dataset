...
var root = [ esl_symbolic.string("root0"), esl_symbolic.string("root1") ];
var space = [ esl_symbolic.string("space0"), esl_symbolic.string("space1") ];
var value = esl_symbolic.boolean("value");
