...
// Vuln: path-traversal
var cfg = esl_symbolic.string("cfg");
var async = esl_symbolic.any("async");
var ret_new_module_exports_IniReaderCore = new module.exports.IniReaderCore(cfg, async);
var file = esl_symbolic.string("file");
var le = esl_symbolic.string("le");
ret_new_module_exports_IniReaderCore.write(file, le);
