...
var obj = [ esl_symbolic.string("obj0"), esl_symbolic.string("obj1") ];
var ret_new_module_exports = new module.exports(obj);
var keyPath =
  [ esl_symbolic.string("keyPath0"), esl_symbolic.string("keyPath1") ];
var value = esl_symbolic.any("value");
var options = { separator: esl_symbolic.any("separator") };
ret_new_module_exports.set(keyPath, value, options);
